...
pub(crate) enum ValueExpression {
    ...
    Xslt10DescendantChildVariablePositionPath {
        path: LocationPath,
        variable: String,
    },
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct Xslt10ComposedPathTranslate {
    pub(crate) path: LocationPath,
    pub(crate) search: Xslt10TranslateOperand,
    pub(crate) replacement: Xslt10TranslateOperand,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum Xslt10TranslateOperand {
    Literal(String),
    Concat(Xslt10ConcatExpression),
}
...
pub(crate) enum LiteralAttributeValue {
    ...
    Xslt10LocalSourcePathCount(LocationPath),
    ContextNormalizedStringLength,
    Xslt10ForEachPathStringValue(LocationPath),
    Xslt10CopyOfPathAttributeValue(LocationPath),
    Xslt10SequenceConstructor(Box<[Instruction]>),
    Xslt10Concat(Box<Xslt10ConcatExpression>),
    ...
    Xslt10TextAndGeneratedKeyIdentity {
        prefix: String,
    ...
    Xslt10TextAndLiteralVariableConcat {
        prefix: String,
        literal: String,
        variable: String,
        suffix: String,
