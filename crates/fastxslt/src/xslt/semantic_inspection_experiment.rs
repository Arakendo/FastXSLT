...
struct OutputInspection {
    ...
    escape_uri_attributes: Option<bool>,
...
fn inspect_output(output: &OutputSettings) -> OutputInspection {
    OutputInspection {
        ...
        escape_uri_attributes: output.escape_uri_attributes,
    ...
    for instruction in instructions {
        *instruction_count = instruction_count
        ...
        let (feature, body) = match instruction {
            ...
            | Instruction::CopyOfAncestorOrSelfElements { .. } => (SemanticFeature::CopyOf, None),
        };
