...
fn match_pattern_owned(value: &MatchPattern) -> usize {
    match value {
        ...
        | MatchPattern::ElementNamespace(value)
        | MatchPattern::AttributeNamespace(value)
        | MatchPattern::AttributeNameEquals(value) => value.capacity(),
    ...
    match value {
        ...
        BooleanExpression::Xslt10AncestorFilter(filter) => {
            size_of_val(filter.as_ref())
                ...
                + filter.value.as_ref().map_or(0, String::capacity)
                + location_owned(&filter.location)
        }
...
fn literal_attribute_value_owned(value: &LiteralAttributeValue) -> usize {
    match value {
        ...
        LiteralAttributeValue::Xslt10TextAndAttributeIntegerOffset {
            ...
            suffix,
            ..
        } => prefix.capacity() + name_owned(name) + suffix.capacity(),
