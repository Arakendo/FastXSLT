...
const EXISTS_DENOMINATOR_SOURCE: &str =
    include_str!("../../../corpus/overlays/qt3/exists-denominator-v0.toml");
const NOT_DENOMINATOR_SOURCE: &str =
    include_str!("../../../corpus/overlays/qt3/not-denominator-v0.toml");
const BOOLEAN_DENOMINATOR_SOURCE: &str =
...
const IRI_TO_URI_DENOMINATOR_SOURCE: &str =
    include_str!("../../../corpus/overlays/qt3/iri-to-uri-denominator-v0.toml");
const LOWER_CASE_DENOMINATOR_SOURCE: &str =
...
fn assert_days_from_duration_denominator() {
    assert_complete_denominator(
        DAYS_FROM_DURATION_DENOMINATOR_SOURCE,
...
fn qt3_denominator_overlays_conserve_their_parent_sets() {
    ...
    assert_complete_denominator(
        DEFAULT_COLLATION_DENOMINATOR_SOURCE,
        "fn/default-collation.xml",
        7,
        7,
        0,
