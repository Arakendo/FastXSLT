...
if ($unsafeBlocks -ne 2 -or $unsafeExports -ne 15 -or $unsafeAllowances -ne 17) {
    throw "ADR-0008 through ADR-0010 unsafe surface changed: blocks=$unsafeBlocks exports=$unsafeExports allowances=$unsafeAllowances"
}
