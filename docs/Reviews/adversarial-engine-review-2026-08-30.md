...
| 6 | **Partially repaired -- live-use evidence required** | Every byte outcome is bounded and engine/outcome publication is atomic. A 100,000-control/outcome abandonment probe confirms growth, complete logical release, and retained empty-map capacity. [AR-0017](../Architectural%20Reviews/AR-0017-native-handle-registry-retention-and-abandonment.md) still requires legitimate live-use and prepared-engine evidence before selecting count, byte, domain, shrink, or isolation policy. |
