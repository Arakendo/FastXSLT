...
| 6 | **Review opened -- measurement required** | [AR-0017](../Architectural%20Reviews/AR-0017-native-handle-registry-retention-and-abandonment.md) separates existing per-object envelope/rollback defects from aggregate quota policy. Abandonment and prepared-engine retention still require measurement before selecting count, byte, domain, or isolation policy. |
