...
Plans describe intended implementation work, sequencing, deliverables, and
acceptance criteria. A plan does not override an ADR or specification. Preserve
completed checkboxes as execution history and mark superseded plans rather than
silently rewriting their original outcome.
...
- [M1 Standards Evidence and Private Vertical Slice](m1-standards-evidence-and-private-vertical-slice.md)
  -- active standards-decision path; pinned W3C case metadata now drives staged
  preview selection while consumer families refine product priorities in
  parallel.
