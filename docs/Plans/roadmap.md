...
1. decompose the remaining XSLT30 `template-005` pressure into named-template
   lookup, parameter binding, conditional evaluation, calls, and bounded
   recursion without implementing them as one opaque special case;
