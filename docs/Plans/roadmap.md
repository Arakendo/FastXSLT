...
string-compatible variable comparison reuse the same typed frames. Multi-step value
...
is a strict 43.14% lower bound over the suite's 2,742 standard-operation cases,
