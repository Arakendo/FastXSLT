...
| QT3 | Immutable submodule `83993587711dbd5c18ed846385ec37d079d6e492` | 428 test sets and 31,821 cases are structurally inventoried; 399 explicitly selected cases execute through two suite-specific XPath adapters. |
...
| --- | ---: | ---: | ---: | ---: |
| `prod/AxisStep.xml` | 349 | 216 | 112 | 21 |
| `fn/deep-equal.xml` | 263 | 183 | 67 | 13 |
| **Audited subtotal** | **612** | **399** | **179** | **34** |

The 612-case subtotal is therefore conserved without relabeling the 34
...
3. [x] Give `AxisStep.xml` and `fn/deep-equal.xml` complete QT3 overlays so all
   ...
   now conserves 399 selected passes, 179 native-dependency profile exclusions,
   and 34 visible default not-run cases against the immutable upstream case
