...
Explicit text, comment, and processing-instruction tests on `self` then reach
721, and the corresponding `preceding` tests reach 724 through three composed
reverse-axis paths. It retains 19 comparator gaps and 35
...
is a strict 26.40% lower bound over the suite's 2,742 standard-operation cases,
