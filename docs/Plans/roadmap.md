...
- [x] Raise it to 1,377 by admitting the exact XSLT 1.0
  `NCName[. > $global]` match predicate over a declared atomic global. Share
  XPath numeric conversion and immutable global lookup across source and
  temporary trees; leave local/non-atomic variables and general comparisons
  unsupported.
