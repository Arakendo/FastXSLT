...
| QT3 | Immutable submodule `83993587711dbd5c18ed846385ec37d079d6e492` | 428 test sets and 31,821 cases are structurally inventoried; 1,107 explicitly selected cases execute through suite-specific XPath adapters. |
...
QT3 now has complete parent overlays for the twenty test sets under active
...
| **Audited subtotal** | **1,378** | **1,107** | **207** | **64** |

The 1,378-case subtotal is therefore conserved without relabeling the 64
...
30,443 QT3 cases remain structural catalog inventory only and still lack
first-party selection dispositions.
...
3. [x] Give `AxisStep.xml`, `fn/deep-equal.xml`, `fn/true.xml`,
   ...
   `fn/months-from-duration.xml`, and `fn/days-from-duration.xml`, so all 1,378
   parent-set cases receive a selection disposition. The typed verifier now
   conserves 1,107 selected passes, 207
...
4. [ ] Add complete denominators deliberately, selected by standards and
   ...
   11,101 XSLT30 and 30,443 QT3 catalog-only cases must stay outside pass/fail
