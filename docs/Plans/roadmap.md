...
selection. Nineteen unchanged cases pass. Initial-template entry now covers
...
remain sealed before compilation. The other 22 cases remain visible defaults
...
| `insn/call-template` | 42 | 19 | 0 | 1 | 22 |
| **Conserved total** | **675** | **459** | **3** | **55** | **158** |
