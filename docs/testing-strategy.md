...
XSLT30 slice resolves five explicit overlay selections and their upstream
environments, stylesheets, and XML assertions. The complete six-case `template`
test set remains accounted for as five passes and one engine-unsupported case.
