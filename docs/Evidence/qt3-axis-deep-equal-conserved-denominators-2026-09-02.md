...
| **Conserved total** | **612** | **333** | **179** | **100** |
...
179 profile exclusions plus 100 visible defaults. The private ledger is also
checked to contain exactly those 333 cases and no third test-set family.
...
This change does not convert the 100 defaults into engine failures, assert that
