...
- Complete twelve-case
  `tests/expr/type-functions/_type-functions-test-set.xml`.
...
and rationale. The verifier parses all three overlays with unknown-field denial,
parses all three pinned native catalogs, proves each case name is unique, and proves
...
The conserved XSLT30 denominator total is now 695 cases: 488 passed
comparisons, 12 engine-unsupported cases, 75 profile exclusions, and 120
visible default not-run cases across 20 complete test sets.
