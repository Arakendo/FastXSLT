...
The complete output denominator moves from 84 to 92 passes and from 148 to 140
visible default not-run cases. Across the eleven conserved XSLT30 denominators,
the total moves from 282 to 290 passes, with 3 engine unsupported cases, 50
profile exclusions, and 188 visible default not-run cases.
