...
| `error` results | 8 |
| `all-of` results | 1 |
| Selected/passed overrides | 16 |
| Default not-run dispositions | 34 |

The one secondary stylesheet belongs to `conflict-resolution-1204`. The 16
...
visibility and 16 case-specific passes only. The remaining 34 cases are not
