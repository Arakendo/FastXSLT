...
| `error` results | 8 |
| `all-of` results | 1 |
| Selected/passed overrides | 15 |
| Default not-run dispositions | 35 |

The one secondary stylesheet belongs to `conflict-resolution-1204`. The 15
...
visibility and 15 case-specific passes only. The remaining 35 cases are not
